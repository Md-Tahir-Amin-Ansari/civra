...
- UI exploration is intentionally separated from runtime work. `docs/UI-REQUIREMENTS.md` is the source brief for comparing external design concepts before committing to a final visual direction.
